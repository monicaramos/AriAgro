...
Begin VB.Form frmCCHorario 
   ...
   Begin VB.Frame FrameAux0 
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   16
         TabIndex        =   24
         Tag             =   "Linea|N|N|||cchorario|numlinea|00|S|"
         Text            =   "lin"
         Top             =   2565
         Visible         =   0   'False
         Width           =   240
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   9
         TabIndex        =   15
         Tag             =   "Cantidad|N|N|||cchorario_tramo|cantidad|###0.0000||"
         Text            =   "cantidad"
         Top             =   2610
         Visible         =   0   'False
         Width           =   1080
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   16
         TabIndex        =   14
         Tag             =   "Codigo Articulo|T|N|||cchorario_tramo|codartic||N|"
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   16
         TabIndex        =   13
         Tag             =   "Codigo palet|N|N|||cchorario|codpalet|000|S|"
         Text            =   "codforfaits"
         Top             =   2565
         Visible         =   0   'False
         Width           =   375
...
Dim Tabla As String
    ...
    Select Case Index
        ...
        Case 0 'ENVASES
            Sql = "SELECT cchorario.codpalet, cchorario.codartic, sartic.nomartic, "
            Sql = Sql & " cchorario.cantidad, "
            If vParamAplic.TipoPrecio = 0 Then
                Sql = Sql & "sartic.preciomp, round(cchorario.cantidad*sartic.preciomp,4) "
            Else
                Sql = Sql & "sartic.preciouc, round(cchorario.cantidad*sartic.preciouc,4) "
            End If
            
            Sql = Sql & ", cchorario.numlinea FROM cchorario, sartic "
            If enlaza Then
                Sql = Sql & ObtenerWhereCab(True)
            Else
                Sql = Sql & " WHERE cchorario.codpalet is null "
            End If
            Sql = Sql & " and cchorario.codartic = sartic.codartic"
            Sql = Sql & " ORDER BY cchorario.numlinea"
...
Dim vWhere As String
    ...
    ' ***** elimina les llínies ****
    conn.Execute "DELETE FROM cchorario " & vWhere
...
Dim Valor As Currency
    ...
    Sql = Sql & " from cchorario, sartic where codpalet = " & DBSet(text1(0).Text, "N")
    Sql = Sql & " and cchorario.codartic = sartic.codartic"
