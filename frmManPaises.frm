...
Begin VB.Form frmManPaises 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   6
      Tag             =   "Letras pais|T|S|||paises|letraspais|||"
      Top             =   4950
      Width           =   495
   End
   Begin VB.ComboBox Combo1 
      ...
      Height          =   315
      Index           =   1
      ItemData        =   "frmManPaises.frx":000C
      Left            =   3195
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   5
      Tag             =   "Simbolo Moneda|T|S|||paises|simmoned|||"
      Top             =   4950
      Width           =   1260
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   5
      TabIndex        =   4
      Tag             =   "Nombre Moneda|T|S|||paises|nommoned|||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.ComboBox Combo1 
      ...
      Height          =   315
      Index           =   0
      ItemData        =   "frmManPaises.frx":0010
      Left            =   2400
      List            =   "frmManPaises.frx":0012
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Tag             =   "Intracomunitario|N|N|0|5|paises|intracom|||"
      Top             =   4920
      Width           =   735
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||paises|nompaise|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|0|999|paises|codpaise|000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManPaises.frx":0014
      Height          =   4410
      Left            =   120
      TabIndex        =   11
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmManPaises"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("paises", "codpaise")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    SQL = "¿Seguro que desea eliminar el País?"
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codpaise=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    SQL = SQL & " ORDER BY paises.codpaise"
    '**************************************************************++
