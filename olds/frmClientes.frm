...
'            End If
    ...
    '        Text1(42).Text = Calculo_CC_IBAN(cta, Text1(42).Text)
                ...
                Else
                    Valor = CStr(Mid(Text1(42).Text, 1, 2))
                    If DevuelveIBAN2(CStr(Valor), cta, cta) Then
                        If Mid(Text1(42).Text, 3) <> cta Then
                            
                            MsgBox "Codigo IBAN distinto del calculado [" & Valor & cta & "]", vbExclamation
...
'    PrimeraVez = False
    ...
    Select Case Index
        Case 0 'destinos
            ...
            tots = "N||||0|;S|txtaux(15)|T|Cód.|400|;" 'codclien,coddesti
            tots = tots & "S|txtaux(0)|T|Nombre|3700|;"
            tots = tots & "S|txtaux(16)|T|Domicilio|2050|;"
            tots = tots & "S|txtaux(1)|T|C.P|600|;"
...
'            DataGridAux(0).Columns(6).Alignment = dbgLeft
        ...
        Case 1 'clientes_precio
            'si es visible|control|tipo campo|nombre campo|ancho control|
            tots = "N||||0|;S|txtaux1(1)|T|Artículo|1200|;S|btnBuscar(0)|B|||;" 'codclien,codartic
            tots = tots & "S|txtaux2(6)|T|Nombre|3700|;"
            tots = tots & "S|txtaux1(2)|T|Precio|1200|;"
...
Dim C As ColumnHeader
    ...
    Case 0
        ...
        Ancho = "1200|1200|2300|1100|1100|"
...
Dim cad As String
    ...
    If Text1(2).Text <> NombreAnt Or Text1(1).Text <> BancoAnt Or Text1(28).Text <> SucurAnt Or Text1(29).Text <> DigitoAnt Or Text1(30).Text <> CuentaAnt Or _
       ...
       EMaiAnt <> Text1(14).Text Or WebAnt <> Text1(9).Text Then
...
'            MsgBox "Datos de Cuenta modificados correctamente.", vbExclamation
    ...
    If Text1(1).Text <> BancoAnt Or Text1(28).Text <> SucurAnt Or Text1(29).Text <> DigitoAnt Or Text1(30).Text <> CuentaAnt Then
        ...
        If HayCobrosPagosPendientes(Text1(24).Text) Then
            If MsgBox(cad, vbQuestion + vbYesNo + vbDefaultButton1) = vbYes Then
                If ActualizarCobrosPagosPdtes(Text1(24), Text1(1).Text, Text1(28).Text, Text1(29).Text, Text1(30).Text) Then
...
Private Function ActualizarCobrosPagosPdtes(vCodmacta As String, vBanco As String, vSucur As String, vDigcon As String, vCta As String) As Boolean
Dim Sql2 As String
