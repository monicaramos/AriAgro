...
Begin VB.Form frmVtasAlbaranes 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(3).Control(1)=   "Text2(6)"
      Tab(3).Control(2)=   "Text2(42)"
      Tab(3).ControlCount=   3
      TabCaption(4)   =   "Agencias Transporte"
      TabPicture(4)   =   "frmVtasAlbaranes.frx":01CA
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "FrameAux3"
      Tab(4).ControlCount=   1
      TabCaption(5)   =   "Devoluciones"
      TabPicture(5)   =   "frmVtasAlbaranes.frx":01E6
      Tab(5).ControlEnabled=   -1  'True
      Tab(5).Control(0)=   "Label8(3)"
      Tab(5).Control(0).Enabled=   0   'False
      Tab(5).Control(1)=   "Label8(4)"
      Tab(5).Control(1).Enabled=   0   'False
      Tab(5).Control(2)=   "Adoaux(5)"
      Tab(5).Control(2).Enabled=   0   'False
      Tab(5).Control(3)=   "Adoaux(4)"
      Tab(5).Control(3).Enabled=   0   'False
      Tab(5).Control(4)=   "DataGrid8"
      Tab(5).Control(4).Enabled=   0   'False
      Tab(5).Control(5)=   "DataGrid7"
      Tab(5).Control(5).Enabled=   0   'False
      Tab(5).Control(6)=   "ToolAux(4)"
      Tab(5).Control(6).Enabled=   0   'False
      Tab(5).ControlCount=   7
      TabCaption(6)   =   "Resultados"
      TabPicture(6)   =   "frmVtasAlbaranes.frx":0202
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "ListView1"
      ...
      Begin VB.TextBox Text2 
         ...
         MaxLength       =   40
         TabIndex        =   209
         Tag             =   "Hora Fin Confec|FH|S|||palets|horafconf|hh:mm:ss||"
         Text            =   "Hora.Ini."
         Top             =   495
         Visible         =   0   'False
         Width           =   1110
      ...
      Begin VB.Frame FrameAux3 
         ...
         Begin VB.ComboBox cmbAux 
            ...
            Style           =   2  'Dropdown List
            TabIndex        =   199
            Tag             =   "Tipo Transporte|N|N|||albaran_transporte|codfortrans|0||"
            Top             =   3240
            Width           =   1260
         End
         Begin VB.TextBox Text2 
         ...
         Begin VB.TextBox txtAux 
            ...
            MaxLength       =   12
            TabIndex        =   202
            Tag             =   "Num.Albaran|N|N|||albaran_transporte|numalbar||S|"
            Text            =   "numalbar"
            Top             =   3240
            Visible         =   0   'False
            Width           =   855
         ...
         Begin VB.TextBox txtAux 
            ...
            MaxLength       =   12
            TabIndex        =   200
            Tag             =   "Num.Linea|N|N|||albaran_transporte|numlinea|00|S|"
            Text            =   "numlinea"
            Top             =   3240
            Visible         =   0   'False
            Width           =   735
         ...
         Begin VB.TextBox txtAux 
            ...
            MaxLength       =   16
            TabIndex        =   198
            Tag             =   "Agencia Transporte|N|N|0|999|albaran_transporte|codtrans|000||"
            Text            =   "transportista"
            Top             =   3240
            Visible         =   0   'False
            Width           =   975
         ...
         Begin VB.TextBox txtAux 
            ...
            MaxLength       =   255
            TabIndex        =   201
            Tag             =   "Observaciones|T|S|||albaran_transporte|observaciones|||"
            Text            =   "observaciones"
            Top             =   3240
            Visible         =   0   'False
            Width           =   3030
         ...
         Begin VB.CommandButton btnBuscar 
            ...
            MaskColor       =   &H00000000&
            TabIndex        =   196
            ToolTipText     =   "Buscar Agencia Transporte"
            Top             =   3240
            Visible         =   0   'False
            Width           =   195
         End
         Begin VB.CheckBox chkAux 
            ...
            Left            =   9630
            TabIndex        =   203
            Tag             =   "Es medio principal|N|N|0|1|albaran_transporte|esmedioppal|||"
            Top             =   3240
            Visible         =   0   'False
            Width           =   255
         End
         ...
         Begin MSDataGridLib.DataGrid DataGrid6 
            Bindings        =   "frmVtasAlbaranes.frx":021E
            Height          =   3495
            Left            =   90
            TabIndex        =   205
            Top             =   495
      ...
      Begin VB.Frame FrameAux1 
         ...
         Begin MSDataGridLib.DataGrid DataGrid4 
            Bindings        =   "frmVtasAlbaranes.frx":0233
            Height          =   3285
            Left            =   45
            TabIndex        =   80
            Top             =   495
      ...
      Begin VB.Frame FrameAux2 
         ...
         Begin MSDataGridLib.DataGrid DataGrid5 
            Bindings        =   "frmVtasAlbaranes.frx":0248
            Height          =   3465
            Left            =   90
            TabIndex        =   83
            Top             =   495
      ...
      Begin VB.Frame FrameAux0 
         ...
         Begin MSDataGridLib.DataGrid DataGrid3 
            Bindings        =   "frmVtasAlbaranes.frx":025D
            Height          =   3495
            Left            =   90
            TabIndex        =   76
            Top             =   495
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmVtasAlbaranes.frx":0272
         Height          =   2055
         Left            =   -74910
         TabIndex        =   60
         Top             =   825
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmVtasAlbaranes.frx":0287
         Height          =   1680
         Left            =   -69105
         TabIndex        =   61
         Top             =   2940
      ...
      Begin MSDataGridLib.DataGrid DataGrid7 
         Bindings        =   "frmVtasAlbaranes.frx":029C
         Height          =   2055
         Left            =   90
         TabIndex        =   244
         Top             =   855
      ...
      Begin MSDataGridLib.DataGrid DataGrid8 
         Bindings        =   "frmVtasAlbaranes.frx":02B1
         Height          =   1680
         Left            =   5850
         TabIndex        =   245
         Top             =   2970
...
Private frmL As frmListado ' devolucion de linea de albaran
    ...
    Select Case Modo
        ...
        Case 5 'Lineas Detalle
            ...
            Select Case SSTab1.Tab
                ...
                '[Monica]15/04/2019:
                Case 4 ' agencias de transporte
                    If ModificaLineas = 1 Then 'INSERTAR
                        ModificaLineas = 0
                        DataGrid6.AllowAddNew = False
                        If Not Adoaux(3).Recordset.EOF Then Adoaux(3).Recordset.MoveFirst
                    End If
                    ModificaLineas = 0
                    LLamaLineas Modo, 0, "DataGrid6"
                    PonerModo 2
...
Dim anc As Single
    ...
    If Modo <> 1 Then
        ...
        anc = DataGrid6.Top
        If DataGrid6.Row < 0 Then
            anc = anc + 240
        Else
            anc = anc + DataGrid6.RowTop(DataGrid6.Row) + 20
        End If
        
        LLamaLineas Modo, anc, "DataGrid6"
...
'            PonerBotonCabecera False
        ...
        Case 5
            vWhere = ObtenerWhereCP(False)
            vWhere = vWhere & " and numlinea=" & Data2.Recordset!NumLinea
            If Not BloqueaRegistro("albaran_transporte", vWhere) Then
                TerminaBloquear
                Exit Sub
            End If
            If DataGrid6.Bookmark < DataGrid6.FirstRow Or DataGrid6.Bookmark > (DataGrid6.FirstRow + DataGrid6.VisibleRows - 1) Then
                J = DataGrid6.Bookmark - DataGrid6.FirstRow
                DataGrid6.Scroll 0, J
                DataGrid6.Refresh
            End If
        ...
        '    anc = ObtenerAlto(Me.DataGrid1)
            ...
            If DataGrid6.Row < 0 Then
                anc = anc + 240
            Else
                anc = anc + DataGrid6.RowTop(DataGrid6.Row) + 10
            End If
        
            txtAux(27).Text = DataGrid6.Columns(0).Text
            txtAux(28).Text = DataGrid6.Columns(1).Text
            
            txtAux(29).Text = DataGrid6.Columns(2).Text
            Text2(44).Text = DataGrid6.Columns(3).Text
            
            PosicionarCombo cmbAux(2), DataGrid6.Columns(4).Text
            
            txtAux(30).Text = DataGrid6.Columns(6).Text
            chkAux(1).Value = DataGrid6.Columns(7).Text
            
            ModificaLineas = 2 'Modificar
            LLamaLineas ModificaLineas, anc, "DataGrid6"
...
Dim b As Boolean
    ...
    Select Case grid
        ...
        Case "DataGrid2"
            ...
            b = (xModo = 1)
            For jj = 8 To 16 ' antes de 0 to txtAux3.Count - 1
        ...
        Case "DataGrid5"
            ...
            For jj = 8 To 13
                ...
                Text2(jj).visible = b
            Next jj
            Text2(11).Left = Text2(42).Left
            Text2(11).Width = Text2(42).Width
            
            Text2(13).Left = Text2(6).Left
            Text2(13).Width = Text2(6).Width
    
        Case "DataGrid6"
            DeseleccionaGrid Me.DataGrid6
            b = (xModo = 1 Or xModo = 2)
            For jj = 29 To 30
                txtAux(jj).Height = DataGrid6.RowHeight - 10
                txtAux(jj).Top = alto + 5
                txtAux(jj).visible = b
            Next jj
            btnBuscar(3).Height = DataGrid6.RowHeight - 10
            btnBuscar(3).Top = alto + 5
            btnBuscar(3).visible = b
            For jj = 44 To 44
                Text2(jj).Height = DataGrid6.RowHeight - 10
                Text2(jj).Top = alto + 5
                Text2(jj).visible = b
            Next jj
            txtAux(27).visible = False
            txtAux(27).Enabled = False
            txtAux(28).visible = False
            txtAux(28).Enabled = False
...
Private Sub DataGrid7_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
Dim i As Byte

    'Datos de la tabla albaran_calibres
    If Not Adoaux(4).Recordset.EOF Then
        'Datos de la tabla albaran_calibres
        CargaGrid DataGrid8, Adoaux(5), True
        Label8(3).Caption = Adoaux(4).Recordset!nomincid
        Label8(4).Caption = "Fecha devolución: " & Adoaux(4).Recordset!fechadev
    Else
        CargaGrid DataGrid8, Adoaux(5), False
        Label8(3).Caption = ""
        Label8(4).Caption = ""
    End If
...
'    End With
    ...
    For kCampo = 0 To ToolAux.Count - 1
        With Me.ToolAux(kCampo)
            ...
            .Buttons(2).Image = 4   'Modificar
            .Buttons(3).Image = 5   'Borrar
            If kCampo = 0 Then .Buttons(4).Image = 26   'devolucion de linea de albaran
        End With
    Next kCampo
...
'Form Mantenimiento de Agencias de Transporte
    txtAux(indice).Text = Format(RecuperaValor(CadenaSeleccion, 1), "000") 'Cod Agencias de Transporte
    Text2(44).Text = RecuperaValor(CadenaSeleccion, 2) 'Descripcion
End Sub
...
Private Sub SSTab1_Click(PreviousTab As Integer)
    ...
    If SSTab1.Tab = 6 Then
        If Data1.Recordset.RecordCount > 0 And SSTab1.Tab = 6 Then
...
'    '---
    ...
    Else
        CadB = CadB & " and " & CadB1
    End If
    cadB2 = ObtenerBusqueda2(Me, chkAux(1), 2, "FrameAux3")
    If cadB2 <> "" Then
        If CadB = "" Then
            CadB = cadB2
        Else
    ...
    ElseIf CadB <> "" Then
        ...
        CadenaConsulta = CadenaConsulta & " LEFT JOIN albaran_transporte on albaran.numalbar = albaran_transporte.numalbar "
...
'                End If
            ...
            Case 6 ' trasnportistas
                If Data1.Recordset.RecordCount > 0 Then
                    CargaGrid DataGrid6, Adoaux(3), True
                Else
                    CargaGrid DataGrid6, Adoaux(3), False
                End If
                
            '[Monica]04/06/2019
            Case 7 ' devoluciones
                If Data1.Recordset.RecordCount > 0 Then
                    CargaGrid DataGrid7, Adoaux(4), True
                    CargaGrid DataGrid8, Adoaux(5), True
                    
                    '[Monica]05/06/2019: ponemos el nombre de incidencia
                    If Not Adoaux(4).Recordset.EOF Then
                        Label8(3).Caption = Adoaux(4).Recordset!nomincid
                        Label8(4).Caption = "Fecha devolución: " & Adoaux(4).Recordset!fechadev
                    Else
                ...
                Else
                    CargaGrid DataGrid7, Adoaux(4), False
                    CargaGrid DataGrid8, Adoaux(5), False
...
'    FormatoDatosTotales
    ...
    '[Monica]16/04/2019: deben introducir el medio de transporte ppal
    ComprobarTransportista
...
Private Sub ComprobarTransportista()
Dim Sql As String
Dim Nregs As Integer

    If Data1.Recordset.EOF Then Exit Sub

    If Adoaux(3).Recordset.EOF Then Exit Sub

    Sql = "select * from albaran_transporte where esmedioppal = 1 and numalbar = " & DBSet(Text1(0), "N")
    Nregs = TotalRegistrosConsulta(Sql)
    If Nregs = 0 Then
        MsgBox "Debe marcar una linea de transporte como principal. Revise.", vbExclamation
    Else
        If Nregs > 1 Then
            MsgBox "Hay más de una agencia de transporte como principal. Revise.", vbExclamation
        End If
    End If
...
'    BloquearTxt Text1(3), b 'referencia
    ...
    BloquearCmb Me.cmbAux(2), (Modo <> 1 And Modo <> 5)
    
    '[Monica]27/06/2018: el cotipom solo se puede consultar
    BloquearTxt Text1(6), Not (Modo = 1)
...
'    Me.imgBuscar(1).visible = False
    ...
    Select Case NumTabMto
        ...
        Case 5
            If Modo <> 1 Then BloquearFrameAux Me, "FrameAux3", Modo, NumTabMto
        ...
        Select Case Index
            Case 0 'variedades
                Select Case Button.Index
                    ...
                    '[Monica]03/06/2019: devolver linea de albaran
                    Case 4 ' devolver linea de albaran
                        Set frmL = New frmListado
                                    'numalbar|numlinea|cajas|kilosnetos|unidades|kilosbrutos|
                        frmL.NumCod = Data3.Recordset.Fields(0).Value & "|" & Data3.Recordset.Fields(1).Value & "|" & Data3.Recordset.Fields(14).Value & "|" & Data3.Recordset.Fields(16).Value & "|" & Data3.Recordset.Fields(15).Value & "|" & Data3.Recordset.Fields(11).Value & "|"
                        frmL.Opcionlistado = 5
                        frmL.Show vbModal
                        Set frmL = Nothing
            ...
            Case 4 ' devoluciones
                Select Case Button.Index
                    Case 2 'modificar variedad
                        Set frmL = New frmListado
                                    'numalbar|numlinea|cajas|kilosnetos|unidades|kilosbrutos|codincid|
                        frmL.NumCod = Adoaux(4).Recordset.Fields(0).Value & "|" & Adoaux(4).Recordset.Fields(1).Value & "|" & Adoaux(4).Recordset.Fields(14).Value & "|" & Adoaux(4).Recordset.Fields(16).Value & "|" & Adoaux(4).Recordset.Fields(15).Value & "|" & Adoaux(4).Recordset.Fields(11).Value & "|" & Adoaux(4).Recordset.Fields(19).Value & "|"
                        frmL.Opcionlistado = 6
                        frmL.Show vbModal
                        Set frmL = Nothing
                        
                    Case 3 ' boton eliminar linea de variedad devuelta
...
Dim Sql As String
    ...
    Select Case Index
       ...
       Case 3 'agencias de transporte
            ' *************** canviar la pregunta ****************
            Cad = "¿Seguro que desea eliminar la Agencia de transporte?"
            Cad = Cad & vbCrLf & "Albarán: " & Adoaux(3).Recordset.Fields(0)
            Cad = Cad & vbCrLf & "Agencia: " & Adoaux(3).Recordset.Fields(2) & "-" & Adoaux(3).Recordset.Fields(3)
            
            If MsgBox(Cad, vbQuestion + vbYesNo) = vbYes Then
                On Error GoTo EEliminarLinea
                Screen.MousePointer = vbHourglass
                NumRegElim = Adoaux(3).Recordset.AbsolutePosition
                TerminaBloquear
               
                Sql = "delete from albaran_transporte where numalbar = " & Adoaux(3).Recordset.Fields(0)
                Sql = Sql & " and numlinea = " & Adoaux(3).Recordset.Fields(1)
                conn.Execute Sql
                
                SituarDataTrasEliminar Adoaux(3), NumRegElim
       ...
       Case 4 ' variedades devolucion
            ' *************** canviar la pregunta ****************
            Cad = "¿Seguro que desea eliminar la Linea de Albarán devuelto?"
            Cad = Cad & vbCrLf & "Albarán: " & Adoaux(4).Recordset.Fields(0)
            Cad = Cad & vbCrLf & "Variedad: " & Adoaux(4).Recordset.Fields(3) '& "-" & Adoaux(4).Recordset.Fields(3)
            
            If MsgBox(Cad, vbQuestion + vbYesNo) = vbYes Then
                On Error GoTo EEliminarLinea
                Screen.MousePointer = vbHourglass
                NumRegElim = Adoaux(4).Recordset.AbsolutePosition
                TerminaBloquear
               
                Sql = "delete from albaran_calibredev where numalbar = " & Adoaux(4).Recordset.Fields(0)
                Sql = Sql & " and numlinea = " & Adoaux(4).Recordset.Fields(1)
                conn.Execute Sql
                
                Sql = "delete from albaran_variedaddev where numalbar = " & Adoaux(4).Recordset.Fields(0)
                Sql = Sql & " and numlinea = " & Adoaux(4).Recordset.Fields(1)
                conn.Execute Sql
                
                SituarDataTrasEliminar Adoaux(4), NumRegElim
...
Dim Sql As String
    ...
    Select Case vDataGrid.Name
        ...
        Case "DataGrid5" 'palets
            Opcion = 5
        Case "DataGrid6" 'transportistas
            Opcion = 6
        Case "DataGrid7" 'devoluciones
            Opcion = 7
        Case "DataGrid8" 'calidades de devoluciones
            Opcion = 8
    End Select
...
'       SQL = SELECT albaran_palets.numalbar, numlinea, numpalet, linconfe, CASE tipmercan WHEN 0 THEN ""Cooperativa"" WHEN 1 THEN ""Terceros"" WHEN 2 THEN ""Mezclado"" WHEN 3 THEN ""Otros"" END, fechaini, time(horaini), fechafin, time(horafin) "
            tots = "N||||0|;N||||0|;"
            tots = tots & "S|txtAux(14)|T|N.Palets|1300|;S|Text2(8)|T|Lin.Confec.|1400|;S|Text2(9)|T|Tipo Mercancia|1750|;S|Text2(10)|T|Fecha Inicio|1500|;S|Text2(42)|T|Hora Inicio|1400|;S|Text2(12)|T|Fecha Fin|1500|;S|Text2(6)|T|Hora Fin|1400|;"
            arregla tots, DataGrid5, Me, 350
            
         Case "DataGrid6" 'albaran_transporte
'        Sql = "SELECT albaran_transporte.numalbar, numlinea, albaran_transporte.codtrans, agencias.nomtrans, albaran_transporte.codfortrans, fortranspor.nombre, albaran_transporte.observaciones, CASE albaran_transporte.esmedioppal WHEN 0 THEN "" "" WHEN 1 THEN ""*""  END "
            tots = "N||||0|;N||||0|;"
            tots = tots & "S|txtAux(29)|T|Codigo|800|;S|btnBuscar(3)|B|||;S|Text2(44)|T|Transportista|4400|;N||||0|;S|cmbAux(2)|T|Tipo Transporte|3850|;S|txtAux(30)|T|Observaciones|7400|;N||||0|;S|chkAux(1)|T|Ppal|500|;"
            arregla tots, DataGrid6, Me, 350
            
            DataGrid6.Columns(5).Alignment = dbgLeft
            DataGrid6.Columns(8).Alignment = dbgCenter
            
            
         Case "DataGrid7" 'albaran_variedaddev
'           SQL = "SELECT numalbar, numlinea, codvarie, nomvarie1, codvarco, nomvarie2, codmarca, nommarca, codforfait, nomforfait, categori, pesobrut, totpalet, preciopro, numcajas, pesoneto
            tots = "N||||0|;N||||0|;N||||0|;"
            tots = tots & "S|txtAux3(3)|T|Variedad Real|2100|;N||||0|;"
            tots = tots & "S|txtAux3(5)|T|Var.Comercial|2100|;N||||0|;S|txtAux3(11)|T|Marca|2480|;N||||0|;S|txtAux3(12)|T|Forfait|2700|;S|txtAux3(8)|T|Cat.|500|;"
            tots = tots & "S|txtAux3(9)|T|Peso Bruto|1200|;S|txtAux3(14)|T|Palets|900|;S|txtAux3(15)|T|Pr.Prov.|1000|;S|txtAux3(13)|T|Cajas|1200|;"
            tots = tots & "S|txtAux3(16)|T|Uds|1200|;S|txtAux3(10)|T|Peso Neto|1700|;"
            tots = tots & "N||||0|;N||||0|;"
            '[Monica]05/06/2019: el codigo y nombre de incidencia está foragrid, fecha devolucion
            tots = tots & "N||||0|;N||||0|;N||||0|;"
            
            arregla tots, DataGrid7, Me, 350
            
            DataGrid7.Columns(3).Alignment = dbgLeft
            DataGrid7.Columns(5).Alignment = dbgLeft
            DataGrid7.Columns(7).Alignment = dbgLeft
            DataGrid7.Columns(9).Alignment = dbgLeft
            
        Case "DataGrid8" 'albaran_calibresdev
'           SQL = "SELECT numalbar, numlinea, numline1, codvarie, codcalib, nomcalib, numcajas, pesoneto
            tots = "N||||0|;N||||0|;N||||0|;"
            tots = tots & "S|txtAux(3)|T|Variedad|1500|;"
            tots = tots & "S|txtAux(4)|T|Calibre|1080|;S|txtAux(5)|T|Nombre Calibre|2000|;S|txtAux(6)|T|Cajas|1300|;S|txtAux(22)|T|Uds|1200|;S|txtAux(7)|T|Peso Neto|1700|;S|Text2(40)|T|Kilos/Caja|1500|;S|Text2(41)|T|Pr.Prov.|1000|;"
            arregla tots, DataGrid8, Me, 350
            
            DataGrid8.Columns(9).Alignment = dbgRight
            DataGrid8.Columns(9).NumberFormat = "###,##0.00"
            DataGrid8.Columns(10).Alignment = dbgRight
    ...
    Select Case Index
        ...
        Case 14 'numero de palet
            If txtAux(Index) <> "" Then
                ...
                Sql = DevuelveDesdeBDNew(cAgro, "palets", "numpalet", "numpalet", ImporteSinFormato(txtAux(Index)), "N")
                If Sql = "" Then
        ...
        Case 29 ' agencia de transporte
            If PonerFormatoEntero(txtAux(Index)) Then
                Text2(44).Text = PonerNombreDeCod(txtAux(Index), "agencias", "nomtrans")
                If Text2(44).Text = "" Then
                    MsgBox "No existe la Agencia de Transporte. Revise.", vbExclamation
                    PonerFoco txtAux(Index)
                Else
                    If Not EsTransportista(txtAux(Index).Text) Then
                        MsgBox "Este código corresponde a un Comisionista." & vbCrLf & "No a una Agencia de Transporte. Revise.", vbExclamation
...
Dim Mens As String
    ...
    If b Then
        ...
        '[Monica]15/04/2019: lineas de transportistas
        'Lineas de transportistas
        conn.Execute "Delete from albaran_transporte " & Sql
...
'[Monica]22/10/2014:
    ...
    CargaGrid DataGrid6, Me.Adoaux(3), False ' agencias de transporte
    
    '[Monica]04/06/2019: devoluciones
    CargaGrid DataGrid7, Me.Adoaux(4), False
    CargaGrid DataGrid8, Me.Adoaux(5), False
...
'        End If
    ...
    Case 6 ' agencias de transporte
        Sql = "SELECT albaran_transporte.numalbar, numlinea, albaran_transporte.codtrans, agencias.nomtrans, albaran_transporte.codfortrans, fortranspor.nombre, albaran_transporte.observaciones, albaran_transporte.esmedioppal ,CASE albaran_transporte.esmedioppal WHEN 0 THEN "" "" WHEN 1 THEN ""*""  END "
        Sql = Sql & " FROM albaran_transporte, fortranspor, agencias "
        Sql = Sql & " WHERE albaran_transporte.codfortrans = fortranspor.codfortrans and albaran_transporte.codtrans = agencias.codtrans "
    
    Case 7  'devoluciones
        Sql = "SELECT albaran_variedaddev.numalbar, numlinea, albaran_variedaddev.codvarie, a.nomvarie as nomvarie1, albaran_variedaddev.codvarco, "
        Sql = Sql & " b.nomvarie as nomvarie2, albaran_variedaddev.codmarca, marcas.nommarca, albaran_variedaddev.codforfait, forfaits.nomconfe, "
        Sql = Sql & " categori, pesobrut, totpalet, preciopro, numcajas, unidades, pesoneto " ', preciodef, albaran_variedad.codincid, inciden.nomincid, "
        Sql = Sql & ", albaran_variedaddev.codpalet, preciodef, albaran_variedaddev.codincid, inciden.nomincid, albaran_variedaddev.fechadev  "
'        SQL = SQL & " impcomis, albaran_variedad.observac "
        Sql = Sql & " FROM albaran_variedaddev, variedades a, variedades b, marcas, forfaits, inciden " 'lineas de variedades del albaran
        Sql = Sql & " WHERE albaran_variedaddev.codvarie = a.codvarie "
        Sql = Sql & " and albaran_variedaddev.codvarco = b.codvarie"
        Sql = Sql & " and albaran_variedaddev.codmarca = marcas.codmarca "
        Sql = Sql & " and albaran_variedaddev.codforfait = forfaits.codforfait "
        Sql = Sql & " and albaran_variedaddev.codincid = inciden.codincid "
     
    Case 8 ' calibres de devoluciones
        Sql = "SELECT numalbar, numlinea, numline1, albaran_calibredev.codvarie, albaran_calibredev.codcalib, nomcalib, numcajas, unidades, pesoneto, round(pesoneto/numcajas,2), preciopro " ', pesoneto "
        Sql = Sql & " FROM albaran_calibredev, calibres WHERE albaran_calibredev.codvarie = calibres.codvarie and "
        Sql = Sql & " albaran_calibredev.codcalib = calibres.codcalib "
    ...
    If enlaza Then
        ...
        If Opcion = 1 Or Opcion = 4 Then
            Sql = Sql & " AND numlinea=" & Data3.Recordset.Fields!NumLinea
        Else
            If Opcion = 8 Then Sql = Sql & " AND numlinea = " & Adoaux(4).Recordset.Fields!NumLinea
        End If
    Else
        Sql = Sql & " and numalbar is null"  '[Monica]24/09/2014: antes numalbar = -1
    End If
    Sql = Sql & " ORDER BY numalbar"
    If (Opcion = 1 Or Opcion = 4 Or Opcion = 6 Or Opcion = 8) Then Sql = Sql & ", numlinea "
    MontaSQLCarga = Sql
End Function
    ...
    For i = 0 To ToolAux.Count - 1
        ...
        If b Then
            Select Case i
              ...
              Case 3
                bAux = (b And Me.Adoaux(3).Recordset.RecordCount > 0) And (NumAlbar = "")
        ...
        If i = 0 Then                                                                     'no facturado
            bAux = (b And Me.Data3.Recordset.RecordCount > 0) And (NumAlbar = "") And Not Label9(2).visible And vParamAplic.Cooperativa = 9
            ToolAux(i).Buttons(4).Enabled = bAux
        End If
        
        '[Monica]05/06/2019: devoluciones
        If i = 4 Then
            ' para el caso de devoluciones solo podemos modificar y eliminar
            bAux = (b And Me.Data3.Recordset.RecordCount > 0) And (NumAlbar = "") And vParamAplic.Cooperativa = 9
            ToolAux(i).Buttons(1).Enabled = False
            ToolAux(i).Buttons(2).Enabled = bAux And Adoaux(4).Recordset.RecordCount > 0
            ToolAux(i).Buttons(3).Enabled = bAux And Adoaux(4).Recordset.RecordCount > 0
        End If
...
Dim frmCMR As frmVtasCMR
    ...
    frmCMR.NomTrans = DevuelveValor("select nomtrans from agencias inner join albaran_transporte on agencias.codtrans = albaran_transporte.codtrans where albaran_transporte.numalbar = " & DBSet(Text1(0), "N") & " and albaran_transporte.esmedioppal = 1")
    frmCMR.Show vbModal
...
Private Sub BotonImprimirPaletsConfeccionados()
Dim cadFormula As String
Dim cadParam As String
Dim numParam As Byte
Dim cadselect As String 'select para insertar en tabla temporal
...
'    Rs.Open Cad, conn, OpenForwardOnly, adLockPessimistic, adCmdText
    ...
    While Not Rs.EOF
        cmbAux(2).AddItem Rs!Nombre
        cmbAux(2).ItemData(cmbAux(2).NewIndex) = Rs!codfortrans
        Rs.MoveNext
    Wend
    Rs.Close
    Set Rs = Nothing
...
Dim b As Boolean
    ...
    Select Case Index
        ...
        Case 5: nomFrame = "FrameAux3" 'transportistas
    End Select
    ' ***************************************************************
...
'                End If
            ...
            End Select
'[Monica]25/04/2019: cambio de lugar del tab de transportista
...
Dim i As Integer
    ...
    Select Case NumTabMto
        ...
        Case 5: vtabla = "albaran_transporte"
    End Select
    ' ********************************************************
...
'                    BloquearTxt txtaux(12), False
        ...
        Case 5
            ...
            AnyadirLinea DataGrid6, Adoaux(3)
    
            anc = DataGrid6.Top
            If DataGrid6.Row < 0 Then
                anc = anc + 240
            Else
                anc = anc + DataGrid6.RowTop(DataGrid6.Row) + 5
            End If
          
            LLamaLineas ModificaLineas, anc, "DataGrid6"
        
            LimpiarCamposLin "FrameAux3"
            txtAux(27).Text = Text1(0).Text 'numero de albaran
            txtAux(28).Text = NumF
            PonerFoco txtAux(29)
            For i = 44 To 44
                Text2(i).Text = ""
...
'            If BLOQUEADesdeFormulario2(Me, Data1, 1) Then BotonModificar
            ...
            Select Case NumTabMto
                ...
                Case 5
                    V = Adoaux(3).Recordset.Fields(1) 'el 2 es el nº de llinia
                    CargaGrid DataGrid6, Adoaux(3), True
                    ...
                    DataGrid6.SetFocus
                    Adoaux(3).Recordset.Find (Adoaux(3).Recordset.Fields(1).Name & " =" & V)

                    LLamaLineas ModificaLineas, 0, "DataGrid6"
...
Dim Albaran As String
    ...
    Else
        ...
        Sql = "delete from albaran_costes where numalbar = " & DBSet(Text1(0).Text, "N")
        ...
        ' albaran_costes
        CadIns6 = "insert into albaran_costes (numalbar,numlinea,tipogasto,codcoste,impcoste,importes,unidades,codartic) values ("
        ...
        Sql2 = "select * from albaran_envase where numalbar = " & DBSet(Albaran, "N")
        Set Rs2 = New ADODB.Recordset
        Rs2.Open Sql2, conn, adOpenForwardOnly, adLockPessimistic, adCmdText
        ...
        Sql2 = "select * from albaran_costes where numalbar = " & DBSet(Albaran, "N")
        Set Rs2 = New ADODB.Recordset
        Rs2.Open Sql2, conn, adOpenForwardOnly, adLockPessimistic, adCmdText
        ...
        While Not Rs2.EOF
            ...
            ComunicaCooperativa "albaran_palets", CadVal6, "I"
