...
Begin VB.Form frmVtasLinPalets 
   ...
   Begin VB.Frame FrameAux0 
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   16
         TabIndex        =   11
         Tag             =   "Número Palet|N|N|||palets_calibre|numpalet|000000|S|"
         Text            =   "numpalet"
         Top             =   2655
         Visible         =   0   'False
         Width           =   735
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox text1 
         ...
         MaxLength       =   7
         TabIndex        =   0
         Tag             =   "Número Palet|N|N|||palets_variedad|numpalet|0000000|S|"
         Text            =   "1234567"
         Top             =   225
         Width           =   765
      End
...
Dim tots As String
    ...
    Select Case Index
        Case 0 'calibres
            ...
            tots = tots & "S|txtAux2(2)|T|Denominación|4000|;S|txtAux(2)|T|Cajas|1300|;"
