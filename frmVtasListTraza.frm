...
Begin VB.Form frmVtasListTraza 
   ...
   ClientTop       =   2430
   ClientWidth     =   6675
   Icon            =   "frmVtasListTraza.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5445
   ...
   Begin VB.Frame FrameCobros 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1455
         MouseIcon       =   "frmVtasListTraza.frx":000C
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1455
         MouseIcon       =   "frmVtasListTraza.frx":015E
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar cliente"
         Top             =   1410
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   5
         Left            =   1455
         MouseIcon       =   "frmVtasListTraza.frx":02B0
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   4
         Left            =   1455
         MouseIcon       =   "frmVtasListTraza.frx":0402
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   2475
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   2
         Left            =   1455
         Picture         =   "frmVtasListTraza.frx":0554
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   3
         Left            =   1455
         Picture         =   "frmVtasListTraza.frx":05DF
         ToolTipText     =   "Buscar fecha"
         Top             =   3885
         Width           =   240
      End
   End
End
Attribute VB_Name = "frmVtasListTraza"
...
'    If Not AnyadirAFormula(cadSelect, Codigo) Then Exit Sub
    ...
    If HayRegParaInforme(cadTABLA, cadselect) Then
        cadTitulo = "Informe de Trazabilidad"
        cadNombreRPT = "rVtasListTraza.rpt"
        LlamarImprimir
    End If
...
Dim List As Collection
   ...
   'IMAGES para busqueda
    ...
    Label1.Caption = "Informe de Traza"
...
Private Sub FrameCobrosVisible(visible As Boolean, ByRef H As Integer, ByRef W As Integer)
    ...
    If visible = True Then
        ...
        Me.FrameCobros.Height = 5400
        Me.FrameCobros.Width = 6615
