...
Begin VB.Form frmManTipUnid 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManTipUnid.frx":000C
      Height          =   5985
      Left            =   120
      TabIndex        =   7
      Top             =   855
   ...
   End
End
Attribute VB_Name = "frmManTipUnid"
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT sunida.codunida, sunida.nomunida, sunida.nomunbre"
    CadenaConsulta = CadenaConsulta & " FROM sunida"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY sunida.codunida"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Unidad|1000|;S|txtAux(1)|T|Denominación|4550|;S|txtAux(2)|T|Abrev.|1000|;"
