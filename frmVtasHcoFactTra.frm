...
Begin VB.Form frmVtasHcoFactTra 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmVtasHcoFactTra.frx":000C
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame2(1)"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Albaranes"
      TabPicture(1)   =   "frmVtasHcoFactTra.frx":0028
      ...
      TabPicture(2)   =   "frmVtasHcoFactTra.frx":0044
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Text5"
      Tab(2).Control(1)=   "Text4(2)"
      Tab(2).Control(2)=   "Text4(1)"
      Tab(2).Control(3)=   "Text4(0)"
      Tab(2).Control(4)=   "DataGrid3"
      Tab(2).Control(5)=   "Label1(13)"
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmVtasHcoFactTra.frx":0060
         Height          =   3825
         Left            =   225
         TabIndex        =   42
         Top             =   2625
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmVtasHcoFactTra.frx":0075
         Height          =   1890
         Left            =   240
         TabIndex        =   43
         Top             =   525
      ...
      Begin MSDataGridLib.DataGrid DataGrid3 
         Bindings        =   "frmVtasHcoFactTra.frx":008A
         Height          =   4545
         Left            =   -74820
         TabIndex        =   106
         Top             =   720
   ...
   Begin VB.Image imgBuscar 
      ...
      Index           =   2
      Left            =   4455
      Picture         =   "frmVtasHcoFactTra.frx":009F
   ...
   Begin VB.Image imgBuscar 
      ...
      Index           =   6
      Left            =   4125
      Picture         =   "frmVtasHcoFactTra.frx":01A1
   ...
   Begin VB.Image imgBuscar 
      ...
      Index           =   5
      Left            =   4140
      Picture         =   "frmVtasHcoFactTra.frx":02A3
      ToolTipText     =   "Buscar trabajador"
      Top             =   2160
      Width           =   240
   End
   ...
   Begin VB.Image imgBuscar 
      ...
      Index           =   4
      Left            =   3270
      Picture         =   "frmVtasHcoFactTra.frx":03A5
      ToolTipText     =   "Buscar trabajador"
      Top             =   1155
      Width           =   240
   End
...
Private WithEvents frmFac As frmBasico2  'manda busqueda previa
...
Dim Aux As String
    ...
    If CadenaSeleccion <> "" Then
        HaDevueltoDatos = True
        Screen.MousePointer = vbHourglass
        CadB = "codtrans = " & DBSet(RecuperaValor(CadenaSeleccion, 3), "N")
...
Dim devuelve As String
    ...
    AyudaFacturasTransporte frmFac, , CadB
...
'        SQL = "SELECT codtrans, numfactu, fecfactu, numalbar, numlinea, importel "
            ...
            tots = tots & "S|txtAux(0)|T|Variedad|2400|;S|txtAux(1)|T|Var.Comercial|2400|;S|txtAux(2)|T|Marca|2200|;S|txtAux(3)|T|Forfait|4000|;S|txtAux(7)|T|Importe|1850|;"     '       S|txtAux(1)|T|Artículo|1750|;S|txtAux(2)|T|Nombre Art.|3150|;"
...
'        SQL = "SELECT codtrans,numfactu,fecfactu,numalbar, fechaalb, importel,observa1,observa2,observa3,observa4,observa5  "
            ...
            tots = "N||||0|;N||||0|;N||||0|;"
            tots = tots & "S|txtAux3(0)|T|Albaran|1400|;S|txtAux3(1)|T|Fecha|1630|;"
...
'        SQL = "SELECT codtrans,numfactu,fecfactu,codmacta, nommacta, importel "
            tots = "N||||0|;N||||0|;N||||0|;"
            tots = tots & "S|Text4(0)|T|Cta.Contable|1900|;S|Text4(2)|T|Descripción|4900|;"
...
Dim Sql As String
    ...
    Select Case Opcion
        ...
        Case 3
            Sql = "SELECT codtrans,numfactu,fecfactu, tcafpv.codmacta, cuentas.nommacta, importel"
            '[Monica]19/09/2017: contabilidad nueva
            If vParamAplic.ContabilidadNueva Then
                Sql = Sql & " FROM tcafpv, ariconta" & vParamAplic.NumeroConta & ".cuentas " 'cabeceras cuentas de portes de vuelta
            Else
    ...
    If enlaza Then
        ...
        If Opcion = 3 Then
            If vParamAplic.ContabilidadNueva Then
                Sql = Sql & " AND tcafpv.codmacta = ariconta" & vParamAplic.NumeroConta & ".cuentas.codmacta "
            Else
                ...
                If bol Then 'si se ha modificado la factura
                    ...
                    If bol Then
                        If vParamAplic.ContabilidadNueva Then
                            ...
                            Sql = " codmacta='" & vFactu.CtaTrans & "' AND numfactu='" & Data1.Recordset.Fields!NumFactu & "'"
                            Sql = Sql & " AND fecfactu='" & Format(Data1.Recordset.Fields!FecFactu, FormatoFecha) & "'"
                            ConnConta.Execute "Delete from pagos WHERE " & Sql
                        Else
                            'Eliminar de la spagop
...
On Error GoTo EContab
    ...
    If Me.Check1(0).Value = 1 Then 'si esta contabilizada
        ...
        '[Monica]20/06/2017: si estamos con la nueva siempre está contabilizada
        If vParamAplic.ContabilidadNueva Then
