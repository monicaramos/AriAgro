...
Begin VB.Form frmManAlmProp 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   2
      Tag             =   "Número Chep|N|N|||salmpr|nrocheps|0000000000||"
      Text            =   "Nro Chep"
      Top             =   4770
      Width           =   1620
   End
...
Dim temp As Boolean
    ...
    Sql = "¿Seguro que desea eliminar el Almacén Propio?"
...
'    adodc1.ConnectionString = Conn
    ...
    tots = "S|txtAux(0)|T|Código|1200|;"
    tots = tots & "S|txtAux(1)|T|Denominación|3900|;S|txtAux(2)|T|Dest.Chep|2100|;"
