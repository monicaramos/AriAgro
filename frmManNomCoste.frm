...
Private Sub MandaBusquedaPrevia(CadB As String)
    ...
    Cad = Cad & ParaGrid(Text1(1), 60, "Descripción")
    If Cad <> "" Then
        Screen.MousePointer = vbHourglass
        ...
        frmB.vTitulo = "Denominación Costes" ' ***** repasa açò: títol de BuscaGrid *****
        frmB.vSelElem = 1
...
Dim tots As String
    ...
    Select Case Index
        Case 0 'cuentas contables
            ...
            tots = "N||||0|;" 'codcoste
            tots = tots & "S|txtAux(1)|T|Linea|800|;S|txtAux(2)|T|Cuenta|1200|;S|btnBuscar(0)|B|||;"
            tots = tots & "S|txtAux2(2)|T|Denominación|3650|;"
