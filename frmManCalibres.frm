...
Begin VB.Form frmManCalibres 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   3
      Tag             =   "Calibre Abrev.|T|N|||calibres|nomcalab|||"
      Top             =   4950
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   1
      Tag             =   "Codigo Calibre|N|S|0|99|calibres|codcalib|00|S|"
      Top             =   4950
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Código Variedad|N|N|0|999999|calibres|codvarie|000000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManCalibres.frx":000C
      Height          =   5985
      Left            =   120
      TabIndex        =   8
      Top             =   900
   ...
   End
End
Attribute VB_Name = "frmManCalibres"
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from calibres where codvarie=" & adodc1.Recordset!codvarie
        Sql = Sql & " and codcalib = " & adodc1.Recordset!codcalib
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
'                        If Not adodc1.Recordset.EOF Then adodc1.Recordset.MoveLast
                        If Not adodc1.Recordset.EOF Then
                            SituarDataMULTI adodc1, "codvarie = " & txtAux(0) & " and codcalib = " & txtAux(1), "" ' Find (adodc1.Recordset.Fields(2).Name & " =" & NuevoCodigo)
                        End If
                        cmdRegresar_Click
                    Else
                        BotonAnyadir
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT calibres.codvarie, variedades.nomvarie, calibres.codcalib,"
    CadenaConsulta = CadenaConsulta & "calibres.nomcalib, calibres.nomcalab"
    CadenaConsulta = CadenaConsulta & " FROM variedades, calibres"
    CadenaConsulta = CadenaConsulta & " WHERE variedades.codvarie = calibres.codvarie "
    '************************************************************************
...
Private Sub frmVar_DatoSeleccionado(CadenaSeleccion As String)
    txtAux(0).Text = RecuperaValor(CadenaSeleccion, 1) 'codvarie
...
'    adodc1.ConnectionString = Conn
    ...
    If ParamVariedad <> "" Then Sql = Sql & " and calibres.codvarie = " & ParamVariedad
    
    
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY calibres.codvarie, calibres.codcalib"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Variedad|1200|;S|btnBuscar(0)|B|||;S|txtAux2(2)|T|Denominación|2600|;"
    tots = tots & "S|txtAux(1)|T|Calibre|1000|;"
    tots = tots & "S|txtAux(2)|T|Descripción|2600|;"
    tots = tots & "S|txtAux(3)|T|Abrev|1000|;"
...
Dim Mens As String
    ...
    If Modo = 3 Then   'Estamos insertando
        Sql = DevuelveDesdeBDNew(cAgro, "calibres", "codcalib", "codvarie", txtAux(0).Text, "N", , "codcalib", txtAux(1).Text, "N")
        If Sql <> "" Then
            MsgBox "Código de calibre existente para esta variedad. Reintroduzca.", vbExclamation
            PonerFoco txtAux(0)
            b = False
        End If
    End If
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={calibres.codvarie}|"
