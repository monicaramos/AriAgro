...
Private WithEvents frmCCosDia As frmBasico2
Attribute frmCCosDia.VB_VarHelpID = -1
...
'    End If
    ...
    Set frmCCosDia = New frmBasico2
    
    AyudaCCostesDiarisoPrev frmCCosDia, , CadB
    
    Set frmCCosDia = Nothing
