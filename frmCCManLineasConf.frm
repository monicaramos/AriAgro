...
Begin VB.Form frmCCManLineasConf 
   ...
   ClientTop       =   330
   ClientWidth     =   6915
   Icon            =   "frmCCManLineasConf.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5490
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox text1 
         ...
         MaxLength       =   2
         TabIndex        =   0
         Tag             =   "Código|N|N|||cccabconf|codlinconf|00|S|"
         Text            =   "12"
         Top             =   270
         Width           =   450
      End
      Begin VB.TextBox text1 
         ...
         MaxLength       =   40
         TabIndex        =   1
         Tag             =   "Nombre|T|N|||cccabconf|nomlinconf|||"
   ...
   Begin VB.Frame FrameAux0 
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   16
         TabIndex        =   12
         Tag             =   "Codigo|N|N|||cclinconf|codlinconf|00|S|"
         Text            =   "codigo"
         Top             =   2565
         Visible         =   0   'False
         Width           =   375
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   4
         TabIndex        =   2
         Tag             =   "Zona|N|N|||cclinconf|codzona|0000|N|"
         Text            =   "zona"
         Top             =   2565
         Visible         =   0   'False
         Width           =   1035
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   16
         TabIndex        =   9
         Tag             =   "Linea|N|N|||cclinconf|numlinea|00|S|"
         Text            =   "lin"
         Top             =   2565
         Visible         =   0   'False
         Width           =   240
   ...
   End
End
Attribute VB_Name = "frmCCManLineasConf"
...
Private WithEvents frmBas As frmBasico 'zonas
...
Dim numNivel As String
    ...
    Select Case Index
        Case 0 'Zonas
            ...
            frmBas.CodigoActual = txtAux(2).Text
            frmBas.Show vbModal
...
Dim i As Integer
    ...
    NombreTabla = "cccabconf"
    Ordenacion = " ORDER BY codlinconf"
    ...
    Data1.RecordSource = "Select * from " & NombreTabla & " where codlinconf=-1"
    Data1.Refresh
...
Dim Tabla As String
    ...
    Select Case Index
        Case 0 'Zonas de la linea de confeccion
            Sql = "SELECT cclinconf.codlinconf, cclinconf.numlinea, cclinconf.codzona, cczonas.nomzona "
            Sql = Sql & " FROM cclinconf, cczonas "
            If enlaza Then
                Sql = Sql & ObtenerWhereCab(True)
            Else
                Sql = Sql & " WHERE cclinconf.codlinconf = -1"
            End If
            Sql = Sql & " and cclinconf.codzona = cczonas.codzona"
            Sql = Sql & " ORDER BY cclinconf.numlinea"
...
'Zonas
    txtAux(2).Text = RecuperaValor(CadenaSeleccion, 1) 'codzona
...
Private Sub MandaBusquedaPrevia(CadB As String)
    ...
    If cad <> "" Then
        ...
        frmB.vTitulo = "Líneas de Confección" ' ***** repasa açò: títol de BuscaGrid *****
        frmB.vSelElem = 1
...
Dim cad As String
    ...
    ' *************** canviar la pregunta ****************
    cad = "¿Seguro que desea eliminar la Línea de Confección?"
...
Dim CPostal As String, desProvi As String, desPais As String
    ...
    If Not Adoaux(0).Recordset.EOF Then
        ...
        ComprobarCuentas Str(Adoaux(0).Recordset!codlinconf)
    End If
...
Dim cad As String, Indicador As String
    ...
    cad = "(codlinconf=" & DBSet(Text1(0).Text, "T") & ")"
...
Dim vWhere As String
    ...
    vWhere = " WHERE codlinconf=" & Data1.Recordset!codlinconf
        
    ' ***** elimina les llínies ****
    conn.Execute "DELETE FROM cclinconf " & vWhere
...
Dim Eliminar As Boolean
    ...
    Select Case Index
        Case 0 'zona de la linea de confeccion
            Sql = "¿Seguro que desea eliminar la Zona de la Línea de Confección?"
            Sql = Sql & vbCrLf & "Zona : " & Adoaux(Index).Recordset!Codzona
            If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
                Eliminar = True
                Sql = "DELETE FROM cclinconf "
...
Dim Nuevo As Boolean
    ...
    Select Case Index
        Case 2 ' zonas
            txtAux2(Index).Text = PonerNombreDeCod(txtAux(Index), "cczonas", "nomzona", "codzona", "N")
...
Dim tots As String
    ...
    Select Case Index
        Case 0 'cuentas contables
            ...
            tots = "N||||0|;" 'codcoste
            tots = tots & "N||||0|;S|txtAux(2)|T|Zona|1200|;S|btnBuscar(0)|B|||;"
'            tots = tots & "S|txtAux(1)|T|Linea|800|;S|txtAux(2)|T|Zona|1200|;S|btnBuscar(0)|B|||;"
            tots = tots & "S|txtAux2(2)|T|Denominación|4450|;"
...
Dim b As Boolean
    ...
    Select Case NumTabMto
        Case 0: nomframe = "FrameAux0" 'zonas
    End Select
...
Dim vWhere As String
    ...
    vWhere = vWhere & " codlinconf=" & Me.Data1.Recordset!codlinconf
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomEmpre & "'|pOrden={cccabconf.codcoste}|"
...
Dim Rs As ADODB.Recordset
    ...
    Sql = "select count(*) from cclinconf where codlinconf = " & DBSet(Coste, "N") & " and numlinea <> " & DBSet(Linea, "N")
    Sql = Sql & " and codzona = " & Trim(Cuenta)
    If DevuelveValor(Sql) <> 0 Then
        MsgBox "Esta zona ya está en otro registro. Revise.", vbExclamation
        Exit Function
    End If
...
Dim b As Boolean
    ...
    Sql = "select numlinea, codzona from cclinconf where codlinconf = " & DBSet(Coste, "N")
    ...
    While Not Rs.EOF And b
        b = ComprobarRestoCuentas(Coste, CStr(Rs!NumLinea), CStr(Rs!Codzona))
        Rs.MoveNext
    Wend
