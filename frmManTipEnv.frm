...
Begin VB.Form frmManTipEnv 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Tipos de Envases Confección"
   ClientHeight    =   7770
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   8940
   Icon            =   "frmManTipEnv.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7770
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   4
      Tag             =   "Orden|N|S|||confenva|numorden|00||"
      Top             =   6165
      Width           =   1395
   End
   Begin VB.CheckBox chkAux 
      ...
      Left            =   3885
      TabIndex        =   3
      Tag             =   "Es Caja|N|N|0|1|confenva|escaja|||"
      Top             =   6195
      Visible         =   0   'False
      Width           =   255
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   2
      Tag             =   "Peso Caja|N|S|||confenva|pesocaja|##0.00||"
      Top             =   6165
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||confenva|nomtipen|||"
      Top             =   6135
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código Tipo de Envase|N|N|0|999|confenva|codtipen|000|S|"
      Top             =   6135
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManTipEnv.frx":000C
      Height          =   5985
      Left            =   120
      TabIndex        =   9
      Top             =   945
   ...
   End
End
Attribute VB_Name = "frmManTipEnv"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("confenva", "codtipen")
    End If
    '********************************************************************
...
Private Sub BotonModificar()
    ...
    txtAux(2).Text = DataGrid1.Columns(2).Text ' peso caja
    Me.chkAux(0).Value = Me.adodc1.Recordset!escaja
    txtAux(3).Text = DataGrid1.Columns(5).Text ' orden
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from confenva where codtipen=" & adodc1.Recordset!Codtipen
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT confenva.codtipen, confenva.nomtipen, confenva.pesocaja, confenva.escaja, IF(confenva.escaja=1,'*','') as descaja, confenva.numorden "
    CadenaConsulta = CadenaConsulta & " FROM confenva"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY confenva.codtipen"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|1000|;S|txtAux(1)|T|Descripción|4150|;S|txtAux(2)|T|Peso Caja|1200|;"
    tots = tots & "N||||0|;S|chkAux(0)|CB|Caja|660|;S|txtAux(3)|T|Orden|900|;"
...
Dim Mens As String
    ...
    ' en el caso de que estmos insertando o modificando no dejamos que se duplique el orden
    If b And (Modo = 3 Or Modo = 4) Then
        If txtAux(3).Text <> "" Then
            Sql = "select numorden from confenva where numorden = " & DBSet(txtAux(3).Text, "N") & " and codtipen <> " & DBSet(txtAux(0).Text, "N")
            If DevuelveValor(Sql) <> 0 Then
                MsgBox "No se permite introducir un número de orden duplicado. Revise.", vbExclamation
                b = False
                PonerFoco txtAux(3)
            End If
        End If
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={confenva.codtipen}|"
