...
Public Function PasarFactura(cadWHERE As String, CodCCost As String, CtaBan As String, cTabla As String) As Boolean
...
Dim Intracom As Integer
    ...
    If Not Rs.EOF Then
        ...
        If Mc.ConseguirContador("1", (Rs!FecRecep <= CDate(FechaFin) - 365), True) = 0 Then
            ...
            Sql = ""
            Sql = Mc.Contador & "," & DBSet(Rs!FecFactu, "F") & "," & Rs!anofacpr & "," & DBSet(Rs!FecRecep, "F") & "," & DBSet(Rs!NumFactu, "T") & "," & DBSet(Rs!Codmacta, "T") & "," & DBSet(Rs!confacpr, "T") & ","
...
Public Function PasarFacturaTrans(cadWHERE As String, CodCCost As String, FechaFin As String) As Boolean
'Insertar en tablas cabecera/lineas de la Contabilidad la factura PROVEEDOR
...
Dim ImporteACompensar As Currency
    ...
    If Not Rsx.EOF Then
        ...
        Sql4 = "select codbanco, codsucur, digcontr, cuentaba, codmacta, ctrolcobroalb, iban from clientes where codclien = " & DBLet(Rsx!CodClien, "N")
...
Dim SeccionHorto As Integer
    ...
    If Not Rsx.EOF Then
        SeccionHorto = DevuelveValor("select seccionhorto from rparam")
        '[Monica]22/11/2013: Tema Iban
        Sql4 = "select codbanco, codsucur, digcontr, cuentaba, rsocios_seccion.codmaccli codmacta, iban from rsocios, rsocios_seccion where rsocios.codsocio = " & DBLet(Rsx!CodSocio, "N")
