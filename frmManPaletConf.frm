...
Begin VB.Form frmManPaletConf 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Paletizacion"
   ClientHeight    =   5880
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8175
   Icon            =   "frmManPaletConf.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5880
   ...
   Begin VB.Frame FrameAux0 
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   16
         TabIndex        =   24
         Tag             =   "Linea|N|N|||confpale_envases|numlinea|00|S|"
         Text            =   "lin"
         Top             =   2565
         Visible         =   0   'False
         Width           =   240
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   9
         TabIndex        =   15
         Tag             =   "Cantidad|N|N|||confpale_envases_envases|cantidad|###0.0000||"
         Text            =   "cantidad"
         Top             =   2610
         Visible         =   0   'False
         Width           =   1080
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   16
         TabIndex        =   14
         Tag             =   "Codigo Articulo|T|N|||confpale_envases_envases|codartic||N|"
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   16
         TabIndex        =   13
         Tag             =   "Codigo palet|N|N|||confpale_envases|codpalet|000|S|"
         Text            =   "codforfaits"
         Top             =   2565
         Visible         =   0   'False
         Width           =   375
      ...
      Begin MSDataGridLib.DataGrid DataGridAux 
         Bindings        =   "frmManPaletConf.frx":000C
         Height          =   2595
         Index           =   0
         Left            =   135
         TabIndex        =   17
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox text1 
         ...
         MaxLength       =   16
         TabIndex        =   2
         Tag             =   "Peso Palet|N|N|||confpale|pesopale|#0.00||"
         Top             =   540
         Width           =   1035
      End
      Begin VB.TextBox text1 
         ...
         MaxLength       =   40
         TabIndex        =   1
         Tag             =   "Descripción|T|N|||confpale|nompalet|||"
      ...
      Begin VB.TextBox text1 
         ...
         MaxLength       =   3
         TabIndex        =   0
         Tag             =   "Código|N|N|0|999|confpale|codpalet|000|S|"
   ...
   End
End
Attribute VB_Name = "frmManPaletConf"
...
Dim I As Integer
    ...
    NombreTabla = "confpale"
    Ordenacion = " ORDER BY codpalet"
    ...
    Data1.RecordSource = "Select * from " & NombreTabla & " where codpalet is null"
    Data1.Refresh
...
Dim Tabla As String
    ...
    Select Case Index
        ...
        Case 0 'ENVASES
            Sql = "SELECT confpale_envases.codpalet, confpale_envases.codartic, sartic.nomartic, "
            Sql = Sql & " confpale_envases.cantidad, "
            If vParamAplic.TipoPrecio = 0 Then
                Sql = Sql & "sartic.preciomp, round(confpale_envases.cantidad*sartic.preciomp,4) "
            Else
                Sql = Sql & "sartic.preciouc, round(confpale_envases.cantidad*sartic.preciouc,4) "
            End If
            
            Sql = Sql & ", confpale_envases.numlinea FROM confpale_envases, sartic "
            If enlaza Then
                Sql = Sql & ObtenerWhereCab(True)
            Else
                Sql = Sql & " WHERE confpale_envases.codpalet is null "
            End If
            Sql = Sql & " and confpale_envases.codartic = sartic.codartic"
            Sql = Sql & " ORDER BY confpale_envases.numlinea"
...
Private Sub MandaBusquedaPrevia(CadB As String)
    ...
    cad = cad & ParaGrid(text1(1), 65, "Descripción")
    cad = cad & ParaGrid(text1(2), 25, "Peso")
    If cad <> "" Then
        ...
        frmB.vTitulo = "Paletización" ' ***** repasa açò: títol de BuscaGrid *****
        frmB.vSelElem = 0
...
Dim cad As String
    ...
    ' *************** canviar la pregunta ****************
    cad = "¿Seguro que desea eliminar el Código de Paletización?"
...
Dim cad As String, Indicador As String
    ...
    cad = "(codpalet=" & DBSet(text1(0).Text, "N") & ")"
...
Dim vWhere As String
    ...
    vWhere = " WHERE codpalet=" & Data1.Recordset!CodPalet
        
    ' ***** elimina les llínies ****
    conn.Execute "DELETE FROM confpale_envases " & vWhere
    ...
    Select Case Index
        Case 0 'envases
            ...
            If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
                eliminar = True
                Sql = "DELETE FROM confpale_envases "
...
Dim I As Integer
    ...
    Select Case Index
        Case 0: vtabla = "confpale_envases"
    End Select
    ...
    Select Case Index
        Case 0, 1 ' *** pose els index dels tabs de llínies que tenen datagrid ***
            ...
            Select Case Index
                ...
                Case 0 'envases
                    txtAux(0).Text = text1(0).Text 'codpalet
...
Dim vWhere As String
    ...
    vWhere = vWhere & " codpalet=" & Me.Data1.Recordset!CodPalet
...
Dim Valor As Currency
    ...
    Sql = Sql & " from confpale_envases, sartic where codpalet = " & DBSet(text1(0).Text, "N")
    Sql = Sql & " and confpale_envases.codartic = sartic.codartic"
