...
Begin VB.Form frmManTipMerc 
   ...
   Begin VB.ComboBox Combo1 
      ...
      Height          =   360
      Index           =   0
      ItemData        =   "frmManTipMerc.frx":000C
      Left            =   2400
      List            =   "frmManTipMerc.frx":000E
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Tag             =   "Tipo|N|N|0|5|tipomer|tiptimer|||"
      Top             =   4920
      Width           =   735
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||tipomer|nomtimer|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código Tipo de Mercado|N|N|0|999|tipomer|codtimer|000|S|"
      Top             =   4920
      Width           =   800
   End
   ...
   End
End
Attribute VB_Name = "frmManTipMerc"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("tipomer", "codtimer")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar el Tipo de Mercado?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from tipomer where codtimer=" & adodc1.Recordset!Codtimer
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codtimer=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT tipomer.codtimer, tipomer.nomtimer, tipomer.tiptimer, "
    CadenaConsulta = CadenaConsulta & "CASE tipomer.tiptimer WHEN 0 THEN ""Interior"" WHEN 1 THEN ""Exportación"" WHEN 2 THEN ""Industria"" WHEN 3 THEN ""Retirada"" "
    CadenaConsulta = CadenaConsulta & "WHEN 4 THEN ""Otros"" END "
'    CadenaConsulta = CadenaConsulta & "tipomer.digicont "
    CadenaConsulta = CadenaConsulta & " FROM tipomer"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY tipomer.codtimer"
    '**************************************************************++
    ...
    tots = tots & "N||||0|;S|Combo1(0)|C|Tipo|2100|;"
'    tots = tots & "S|txtAux(2)|T|Digito Cont.|1000|;"
...
Dim Rs As ADODB.Recordset
    ...
    Combo1(0).AddItem "Interior"
    Combo1(0).ItemData(Combo1(0).NewIndex) = 0
    Combo1(0).AddItem "Exportación"
    Combo1(0).ItemData(Combo1(0).NewIndex) = 1
    Combo1(0).AddItem "Industria"
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={tipomer.codtimer}|"
