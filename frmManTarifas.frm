...
Begin VB.Form frmManTarifas 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   15
      TabIndex        =   1
      Tag             =   "Tarifa Trasporte|N|N|||tarifas|tarifatr|0.0000||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|0|999|tarifas|codtarif|000|S|"
      Top             =   4920
      Width           =   800
   End
   ...
   End
End
Attribute VB_Name = "frmManTarifas"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("tarifas", "codtarif")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar la Tarifa de Trasnporte?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from tarifas where codtarif=" & adodc1.Recordset!Codtarif
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codtarif=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT tarifas.codtarif, tarifas.tarifatr"
    CadenaConsulta = CadenaConsulta & " FROM tarifas"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY tarifas.codtarif"
    '**************************************************************++
...
Private Sub txtAux_LostFocus(Index As Integer)
    ...
    Select Case Index
        ...
        Case 1
            If txtAux(Index).Text <> "" Then PonerFormatoDecimal txtAux(Index), 6
    End Select
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={tarifas.codtarif}|"
