...
Begin VB.Form frmManMarcas 
   ...
   Begin VB.ComboBox Combo1 
      ...
      Height          =   360
      Index           =   0
      ItemData        =   "frmManMarcas.frx":000C
      Left            =   2430
      List            =   "frmManMarcas.frx":000E
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Tag             =   "Tipo Marca|N|N|0|1|marcas|tipmarca|||"
      Top             =   4905
      Width           =   735
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||marcas|nommarca|||"
      Top             =   4905
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código de Marca|N|N|0|999|marcas|codmarca|000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManMarcas.frx":0010
      Height          =   5985
      Left            =   120
      TabIndex        =   7
      Top             =   945
   ...
   End
End
Attribute VB_Name = "frmManMarcas"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("marcas", "codmarca")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar la Marca?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from marcas where codmarca=" & adodc1.Recordset!Codmarca
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codmarca=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT marcas.codmarca, marcas.nommarca, marcas.tipmarca, "
    CadenaConsulta = CadenaConsulta & "CASE marcas.tipmarca WHEN 0 THEN ""Propia"" WHEN 1 THEN ""Ajena"" End "
    
    CadenaConsulta = CadenaConsulta & " FROM marcas"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY marcas.codmarca"
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|1000|;S|txtAux(1)|T|Descripción|3650|;"
    tots = tots & "N||||0|;S|Combo1(0)|C|Tipo|1900|;"
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={marcas.codmarca}|"
