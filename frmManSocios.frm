...
Begin VB.Form frmManSocios 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Código|N|N|0|999999|rsocios|codsocio|000000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManSocios.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   6
      Top             =   540
...
Public Event DatoSeleccionado(rsocioseleccion As String)
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rsocios", "codsocio")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from rsocios where codsocio=" & adodc1.Recordset!CodSocio
        conn.Execute SQL
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rsocios.codsocio, rsocios.nomsocio"
    CadenaConsulta = CadenaConsulta & " FROM rsocios"
...
'    adodc1.ConnectionString = Conn
    ...
    tots = "S|txtAux(0)|T|Cód.|800|;S|txtAux(1)|T|Nombre|3500|;"
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomEmpre & "'|pOrden={rsocios.codsocio}|"
