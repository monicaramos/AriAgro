...
Begin VB.Form frmMensajes 
   ...
   Begin VB.Frame FrameCorreccionPrecios 
      ...
      Begin VB.ComboBox cmbActualizarTar 
         Height          =   315
         ItemData        =   "frmMensajes.frx":02C6
         Left            =   7800
         List            =   "frmMensajes.frx":02D3
         Style           =   2  'Dropdown List
         TabIndex        =   41
         Top             =   5960
         Width           =   2175
