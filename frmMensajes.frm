...
Begin VB.Form frmMensajes 
   ...
   Begin VB.Frame FrameDatosFactura 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   14
         Left            =   1905
         MouseIcon       =   "frmMensajes.frx":0097
         MousePointer    =   4  'Icon
   ...
   Begin VB.Frame FrameCorreccionPrecios 
      ...
      Begin VB.ComboBox cmbActualizarTar 
         Height          =   315
         ItemData        =   "frmMensajes.frx":0717
         Left            =   7800
         List            =   "frmMensajes.frx":0724
         Style           =   2  'Dropdown List
         TabIndex        =   41
         Top             =   5960
         Width           =   2175
   ...
   Begin VB.Frame FrameFrasPteContabilizar 
      ...
      Begin VB.ComboBox Combo1 
         ...
         Height          =   360
         Index           =   0
         ItemData        =   "frmMensajes.frx":1444
         Left            =   240
         List            =   "frmMensajes.frx":144E
         Style           =   2  'Dropdown List
         TabIndex        =   96
...
Dim IT As ListItem
    ...
    Select Case Label5.Caption
        ...
        '[Monica]17/06/2013: añadimos las categorias
        Case "Categorias"
...
Dim i As Integer
    ...
    ListView9.ColumnHeaders.Add , , "Código", 800.2522, 1
...
Dim Sql As String
    ...
    lw(0).ColumnHeaders.Add , , "Código", 1100.2522, 0
...
Dim IT As ListItem
    ...
    ListView10.ColumnHeaders.Add , , "Código", 1000.0631
