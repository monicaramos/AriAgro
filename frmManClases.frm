...
Begin VB.Form frmManClases 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   15
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||clases|nomclase|||"
      Top             =   5820
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|0|999|clases|codclase|000|S|"
      Top             =   5820
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManClases.frx":000C
      Height          =   5985
      Left            =   120
      TabIndex        =   6
      Top             =   855
   ...
   End
End
Attribute VB_Name = "frmManClases"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("clases", "codclase")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar la Clase?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from clases where codclase=" & adodc1.Recordset!Codclase
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codclase=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT clases.codclase, clases.nomclase"
    CadenaConsulta = CadenaConsulta & " FROM clases"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY clases.codclase"
    '**************************************************************++
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={clases.codclase}|"
