...
Begin VB.Form frmManPaleConf 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManPaleConf.frx":000C
      Height          =   5985
      Left            =   120
      TabIndex        =   7
      Top             =   810
   ...
   End
End
Attribute VB_Name = "frmManPaleConf"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("confpale", "codpalet")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar la Paletización de Confección?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from confpale where codpalet=" & adodc1.Recordset!CodPalet
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codpalet=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT confpale.codpalet, confpale.nompalet, confpale.pesopale "
    CadenaConsulta = CadenaConsulta & " FROM confpale"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY confpale.codpalet"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|1000|;S|txtAux(1)|T|Descripción|4050|;S|txtAux(2)|T|Peso Palet|1500|;"
