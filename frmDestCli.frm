...
Begin VB.Form frmDestCli 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Destinos de Cliente"
   ClientHeight    =   7695
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   9345
   Icon            =   "frmDestCli.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7695
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   3
      Tag             =   "Codigo Palet|T|S|||destinos|codpalet|||"
      Text            =   "Dato2"
      Top             =   4680
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   2
      Tag             =   "Código Cajas|T|S|||destinos|codcajas|||"
      Text            =   "Dato2"
      Top             =   4680
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   0
      Tag             =   "Código de Destino|T|N|||destinos|coddesti||S|"
      Text            =   "Dat"
      Top             =   4680
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Nombre Destino|T|N|||destinos|nomdesti|||"
      Text            =   "Dato2"
      Top             =   4680
      Width           =   1395
   End
...
Private Sub cmdAceptar_Click()
    Select Case Modo
        Case 1  'BUSQUEDA
            ...
            If CadB <> "" Then
                PonerModo 2
                CargaGrid CadB & " AND codclien=" & Cliente
...
'    PonerOpcionesMenu  'En funcion del usuario
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "Select coddesti, nomdesti, codcajas, codpalet from destinos "
    '************************************************************************
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    'codmacta, nommacta
    tots = "S|txtAux(0)|T|Código|1000|;S|txtAux(1)|T|Descripción|4400|;"
    tots = tots & "S|txtAux(2)|T|Cod.Cajas|1500|;S|txtAux(3)|T|Cod.Palet|1500|;"
