...
'    End With
    ...
    CadenaConsulta = "Select * from " & NombreTabla & " WHERE codartic is null"
...
On Error GoTo ECarga
    ...
    tots = tots & "S|txtAux(2)|T|Hora|1350|;S|txtAux(3)|T|Existencia|1650|;"
...
Dim devuelve As String 'Para mensajes
    ...
    Select Case Index
        Case 0 'cod. almacen
            ...
            Else
                devuelve = DevuelveDesdeBD("nomalmac", "salmpr", "codalmac", txtAux(Index).Text, "N")
'                Text2(1).Text = SQL
...
Dim b As Boolean
    ...
    'Modificar
    Toolbar1.Buttons(1).Enabled = False '--monica: antes b
