...
Begin VB.Form frmVtasReimpFact 
   ...
   ClientTop       =   2430
   ClientWidth     =   6600
   Icon            =   "frmVtasReimpFact.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5280
   ...
   Begin VB.Frame FrameCobros 
      ...
      Begin VB.Label Label1 
         Caption         =   "Reimpresión de Facturas de Venta"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   14.25
            Charset         =   0
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   2
         Left            =   1485
         Picture         =   "frmVtasReimpFact.frx":000C
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   3
         Left            =   1485
         Picture         =   "frmVtasReimpFact.frx":0097
         ToolTipText     =   "Buscar fecha"
         Top             =   3135
         Width           =   240
      End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1470
         MouseIcon       =   "frmVtasReimpFact.frx":0122
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1485
         MouseIcon       =   "frmVtasReimpFact.frx":0274
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar cliente"
         Top             =   4140
         Width           =   240
   ...
   End
End
Attribute VB_Name = "frmVtasReimpFact"
