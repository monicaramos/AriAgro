...
Begin VB.Form frmManSitua 
   ...
   Begin VB.ComboBox Combo1 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "frmManSitua.frx":000C
      Left            =   3240
      List            =   "frmManSitua.frx":000E
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Tag             =   "Bloqueo|N|N|0|1|ssitua|tipsitua|||"
      Top             =   6900
      Width           =   735
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción de Situación|T|N|||ssitua|nomsitua|||"
      Top             =   6900
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   0
      Tag             =   "Código de Situación|N|N|0|99|ssitua|codsitua|00|S|"
      Top             =   6900
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManSitua.frx":0010
      Height          =   5985
      Left            =   120
      TabIndex        =   5
      Top             =   990
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("ssitua", "codsitua")
    End If
    '********************************************************************
...
Private Sub BotonModificar()
    ...
    SelComboBool DataGrid1.Columns(2).Text, Combo1
    ' *****************************************************
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codprove=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT codsitua, nomsitua, tipsitua,CASE tipsitua WHEN 0 THEN ""No Bloquea"" WHEN 1 THEN ""Bloquea"" END FROM ssitua"
    '************************************************************************
...
'    DataGrid1.RowHeight = 290
    ...
    tots = "S|txtAux(0)|T|Código|1000|;S|txtAux(1)|T|Descripción|3187|;"
    tots = tots & "N||||0|;S|Combo1|C|Tipo|2000|;"
...
'         Datos = DevuelveDesdeBD("codprovi", "provinci", "codprovi", txtAux(0).Text, "N")
'         If Datos <> "" Then
'            MsgBox "Ya existe el Código de Provincia: " & txtAux(0).Text, vbExclamation
'            DatosOk = False
'            PonerFoco txtAux(0)
'            Exit Function
'        End If
...
Dim Rs As ADODB.Recordset
    ...
    Combo1.AddItem "No Bloquea"
    Combo1.ItemData(Combo1.NewIndex) = 0
    Combo1.AddItem "Bloquea"
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={ssitua.codsitua}|"
