...
Begin VB.Form frmANECOOPAux 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Lineas de Albaranes "
   ClientHeight    =   5925
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7230
   Icon            =   "frmANECOOPAux.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5925
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   4
      Tag             =   "Num.Cajas|N|N|||anecoopaux|numcajas|###,##0||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   3
      Tag             =   "Peso Neto|N|N|||anecoopaux|pesoneto|###,##0||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   1
      Tag             =   "Albaran|N|S|||anecoopaux|numalbar|0000000|S|"
      Top             =   4920
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   12
      TabIndex        =   2
      Tag             =   "Linea|T|N|||anecoopaux|numlinea|000|S|"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Código Usuario|N|N|||anecoopaux|codusu||S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmANECOOPAux.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   9
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmANECOOPAux"
...
Private Sub BotonBuscar()
    ...
    CargaGrid "anecoopaux.numalbar isnull"
    '*******************************************************************************
    'Buscar
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = Sql & vbCrLf & "Linea: " & adodc1.Recordset.Fields(2)
    
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        'Hay que eliminar
        NumRegElim = adodc1.Recordset.AbsolutePosition
        
        Sql = "Delete from anecoopaux where codusu=" & adodc1.Recordset!Codusu
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT anecoopaux.codusu, anecoopaux.numalbar, anecoopaux.numlinea,"
    CadenaConsulta = CadenaConsulta & " anecoopaux.pesoneto, anecoopaux.numcajas  "
    CadenaConsulta = CadenaConsulta & " FROM anecoopaux"
    CadenaConsulta = CadenaConsulta & " WHERE anecoopaux.codusu = " & DBSet(vUsu.Codigo, "N")
    '************************************************************************
...
'    adodc1.ConnectionString = Conn
    ...
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY anecoopaux.numalbar,anecoopaux.numlinea"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "N||||0|;S|txtAux(1)|T|Albaran|900|;"
    tots = tots & "S|txtAux(2)|T|Linea|700|;"
    tots = tots & "S|txtAux(3)|T|Peso Neto|2150|;"
    tots = tots & "S|txtAux(4)|T|Cajas|2150|;"
...
Dim Mens As String
    ...
    If Modo = 3 Then   'Estamos insertando
        Sql = DevuelveDesdeBDNew(cAgro, "anecoopaux", "codcalib", "codvarie", txtAux(0).Text, "N", , "codcalib", txtAux(1).Text, "N")
        If Sql <> "" Then
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "anecoopaux"
        .Informe2 = "rMananecoopaux.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={anecoopaux.codvarie}|"
