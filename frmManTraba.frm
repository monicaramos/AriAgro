...
'        Else
            ...
            If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codtraba like " & DBSet(CodigoActual, "N"), "", True
            End If
'        End If
    End If
...
'    PonerOpcionesMenu  'En funcion del usuario
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "Select codtraba, nomtraba from straba "
    '************************************************************************

    
    CadB = ""
    CargaGrid "" '    lblIndicador.Caption = ""
'    PonerModo 2
End Sub
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    'codmacta, nommacta
    tots = "S|txtAux(0)|T|Código|1000|;S|txtAux(1)|T|Nombre|3400|;"
