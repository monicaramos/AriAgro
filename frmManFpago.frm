...
'                lblIndicador.Caption = "BUSQUEDA: " & PonerContRegistros(Me.adodc1)
        ...
        Case 3 'INSERTAR
            If DatosOk Then
'[Monica]17/04/2013: insertamos o modificamos en la contabilidad
...
'                        If Not adodc1.Recordset.EOF Then adodc1.Recordset.MoveLast
        ...
        Case 4 'MODIFICAR
            If DatosOk Then
'[Monica]17/04/2013: modificamos tambien en la contabilidad
...
'    adodc1.ConnectionString = Conn
    ...
    tots = "S|txtAux(0)|T|Código|1000|;S|txtAux(1)|T|Descripción|5150|;"
    tots = tots & "N||||0|;S|Combo1(0)|C|Tipo|2550|;"
    tots = tots & "S|txtAux(2)|T|Vencimientos|1500|;S|txtAux(3)|T|Dias 1er.Vto|1700|;S|txtAux(4)|T|Resto Vto.|1500|;"
