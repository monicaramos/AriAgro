...
Begin VB.Form frmManTipArtic 
   ...
   Begin VB.CheckBox chkAux 
      ...
      Left            =   2340
      TabIndex        =   2
      Tag             =   "Retornable|N|N|||stipar|esretornable|||"
      Top             =   4950
      Visible         =   0   'False
      Width           =   360
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||stipar|nomtipar|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código Tipo de Envase|T|N|||stipar|codtipar||S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManTipArtic.frx":000C
      Height          =   5985
      Left            =   120
      TabIndex        =   7
      Top             =   945
   ...
   End
End
Attribute VB_Name = "frmManTipArtic"
...
Dim b As Boolean
    ...
    'Insertar
    Toolbar1.Buttons(1).Enabled = b And Not DeConsulta And vUsu.Nivel <= 1
    Me.mnNuevo.Enabled = b And Not DeConsulta And vUsu.Nivel <= 1
    
    b = (b And adodc1.Recordset.RecordCount > 0) And Not DeConsulta
    'Modificar
    Toolbar1.Buttons(2).Enabled = b And vUsu.Nivel <= 1
    Me.mnModificar.Enabled = b And vUsu.Nivel <= 1
    'Eliminar
    Toolbar1.Buttons(3).Enabled = b And vUsu.Nivel <= 1
    Me.mnEliminar.Enabled = b And vUsu.Nivel <= 1
    'Imprimir
...
'    SelComboBool DataGrid1.Columns(2).Text, Combo1(0)
    ' *****************************************************
    Me.chkAux(0).Value = Me.adodc1.Recordset!esretornable
...
Dim temp As Boolean
    ...
    Sql = "¿Seguro que desea eliminar el Tipo de Envase?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from stipar where codtipar=" & DBSet(adodc1.Recordset!codTipar, "T")
        conn.Execute Sql
        CargaGrid CadB
...
Dim Valor As Integer
    ...
    Valor = Me.adodc1.Recordset.Fields(0).Value
    If Valor >= 0 And Valor <= 9 Then
        MsgBox "No es puede modificar ni eliminar este registro. " & vbCrLf & vbCrLf & "Del 0 al 9 están reservados.", vbExclamation
        Exit Function
    End If
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codtipen=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT stipar.codtipar, stipar.nomtipar"
    CadenaConsulta = CadenaConsulta & ", esretornable, IF(esretornable=1,'*','') as desretornable "
    CadenaConsulta = CadenaConsulta & " FROM stipar"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY stipar.codtipar"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Tipo|1000|;S|txtAux(1)|T|Descripción|4270|;N||||0|;S|chkAux(0)|CB|Retornable|1280|;"
...
Dim Mens As String
    ...
    If b And (Modo = 3 Or Modo = 4) Then
        If CInt(txtAux(0).Text) >= 0 And CInt(txtAux(0).Text) <= 9 Then
            If Modo = 3 Then
                MsgBox "No se puede añadir este registro." & vbCrLf & vbCrLf & "Del 0 al 9 están reservados.", vbExclamation
            Else
                MsgBox "No se puede modificar este registro." & vbCrLf & vbCrLf & "Del 0 al 9 están reservados.", vbExclamation
            End If
            b = False
        End If
    End If
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={stipar.codtipar}|"
