...
Dim b As Boolean
    ...
    'Insertar
    Toolbar1.Buttons(6).Enabled = b And Not DeConsulta And vUsu.Nivel <= 1
    Me.mnNuevo.Enabled = b And Not DeConsulta And vUsu.Nivel <= 1
    
    b = (b And adodc1.Recordset.RecordCount > 0) And Not DeConsulta
    'Modificar
    Toolbar1.Buttons(7).Enabled = b And vUsu.Nivel <= 1
    Me.mnModificar.Enabled = b And vUsu.Nivel <= 1
    'Eliminar
    Toolbar1.Buttons(8).Enabled = b And vUsu.Nivel <= 1
...
'    adodc1.ConnectionString = Conn
    ...
    tots = "S|txtAux(0)|T|Tipo|500|;S|txtAux(1)|T|Descripción|3690|;N||||0|;S|chkAux(0)|CB|Ret|380|;"
