...
Begin VB.Form frmManGrupos 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   2
      Tag             =   "Siglas Atria|T|S|||grupopro|codatria|||"
      Top             =   4890
      Width           =   765
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||grupopro|nomgrupo|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código de Grupo|N|N|0|999|grupopro|codgrupo|000|S|"
      Top             =   4905
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManGrupos.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   5
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmManGrupos"
...
Dim b As Boolean
    ...
    'Modificar
    Toolbar1.Buttons(7).Enabled = False 'b
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("grupopro", "codgrupo")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar el Grupo de Producto?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from grupopro where codgrupo=" & adodc1.Recordset!codgrupo
        Conn.Execute Sql
        CargaGrid cadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT grupopro.* FROM grupopro where 1 = 1 "
    '************************************************************************
...
'    DataGrid1.RowHeight = 290
    ...
    tots = "S|txtAux(0)|T|Código|700|;S|txtAux(1)|T|Descripción|4187|;S|txtAux(2)|T|Atria|600|;"
