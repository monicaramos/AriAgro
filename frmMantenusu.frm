...
Dim J As Integer
    ...
    SQL = "Select * from usuarios.appmenus where aplicacion='Ariagro'"
    ...
    SQL = "Select * from usuarios.appmenususuario where aplicacion='Ariagro' AND codusu =" & ListView1.SelectedItem.Text
    miRsAux.Open SQL, Conn, adOpenForwardOnly, adLockPessimistic, adCmdText
    While Not miRsAux.EOF
...
Private Sub GuardarMenuUsuario()
    SQL = "DELETE from usuarios.appmenusUsuario where aplicacion='Ariagro' AND codusu =" & ListView1.SelectedItem.Text
    Conn.Execute SQL
    
    i = 0
    SQL = "INSERT INTO usuarios.appmenususuario (aplicacion, codusu, codigo, tag) VALUES ('Ariagro'," & ListView1.SelectedItem.Text & ","
