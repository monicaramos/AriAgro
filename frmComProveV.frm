...
Dim Cad As String
    ...
    Cad = "¿Seguro que desea eliminar el Proveedor de Varios?" & vbCrLf
...
Dim b As Boolean
    ...
    DatosOk = False
    b = CompForm(Me) 'Comprobar datos OK
    If Not b Then Exit Function
        
    'Comprobamos  si existe
    If Modo = 3 Then 'Si estamos insertando
        'BD 1: conexion a BD Ariges
        If DevuelveDesdeBD("nifprove", NombreTabla, "nifprove", Text1(0).Text, "T") <> "" Then
            b = False
