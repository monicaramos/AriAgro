...
Begin VB.Form frmManCapEnv 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Capacidad de Envases"
   ClientHeight    =   7650
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   7365
   Icon            =   "frmManCapEnv.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7650
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||capacida|nomcapac|||"
      Top             =   6630
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|0|999|capacida|codcapac|000|S|"
      Top             =   6630
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManCapEnv.frx":000C
      Height          =   5985
      Left            =   120
      TabIndex        =   6
      Top             =   900
   ...
   End
End
Attribute VB_Name = "frmManCapEnv"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("capacida", "codcapac")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar el Tipo de Capacidad de Envase?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from capacida where codcapac=" & adodc1.Recordset!Codcapac
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codcapac=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT capacida.codcapac, capacida.nomcapac"
    CadenaConsulta = CadenaConsulta & " FROM capacida"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY capacida.codcapac"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|1000|;S|txtAux(1)|T|Descripción|5450|;"
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={capacida.codcapac}|"
