...
Begin VB.Form frmVtasAlbTraPdtes 
   ...
   ClientTop       =   2430
   ClientWidth     =   6840
   Icon            =   "frmVtasAlbTraPdtes.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7395
   ...
   Begin VB.Frame FrameCobros 
      ...
      Begin VB.Label Label1 
         Caption         =   "Albaranes Pendientes Facturar Transporte"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   14.25
            Charset         =   0
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   3
         Left            =   1215
         MouseIcon       =   "frmVtasAlbTraPdtes.frx":000C
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   2
         Left            =   1230
         MouseIcon       =   "frmVtasAlbTraPdtes.frx":015E
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar agencia"
         Top             =   5235
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   5
         Left            =   1215
         MouseIcon       =   "frmVtasAlbTraPdtes.frx":02B0
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   4
         Left            =   1230
         MouseIcon       =   "frmVtasAlbTraPdtes.frx":0402
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   3795
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1245
         MouseIcon       =   "frmVtasAlbTraPdtes.frx":066A
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1230
         MouseIcon       =   "frmVtasAlbTraPdtes.frx":07BC
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar cliente"
         Top             =   2970
         Width           =   240
   ...
   End
End
Attribute VB_Name = "frmVtasAlbTraPdtes"
...
'   cadTABLA = tabla & " INNER JOIN albaran_variedad ON albaran.numalbar = albaran_variedad.numalbar "
    ...
    If ProcesarCambios(cadselect) Then
          ...
          cadTitulo = "Albaranes Pendientes de Facturar Transporte"
          cadNombreRPT = "rAlbPdtesTrans.rpt"
          LlamarImprimir
          'AbrirVisReport
    End If
End Sub
